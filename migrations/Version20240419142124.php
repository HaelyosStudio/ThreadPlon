 ...
 */
final class Version20240419142124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE response_vote (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, response_id INT NOT NULL, vote TINYINT(1) NOT NULL, INDEX IDX_F6B18FFEA76ED395 (user_id), INDEX IDX_F6B18FFEFBF32840 (response_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
