 ...
 */
final class Version20240416090056 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE thread_has_cat (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, thread_id INT NOT NULL, INDEX IDX_1B24F61BE2904019 (thread_id), INDEX IDX_1B24F61B12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE thread_has_cat ADD CONSTRAINT FK_1B24F61B12469DE2 FOREIGN KEY (category_id) REFERENCES category (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE thread_has_cat ADD CONSTRAINT FK_1B24F61BE2904019 FOREIGN KEY (thread_id) REFERENCES thread (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
