 ...
 */
final class Version20240415125453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE response ADD thread_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE response DROP thread_id, CHANGE user_id user_id INT NOT NULL');
    }
}
